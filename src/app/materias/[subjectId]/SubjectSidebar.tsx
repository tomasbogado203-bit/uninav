...
export default function SubjectSidebar({
  ...
  // Acordeón de temas: abierto por defecto SOLO si estamos en la ruta de temas
  ...
  // Capitalizar nombre de la materia
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute -right-3 top-5 z-20 flex h-6 w-6 items-center justify-center rounded-full border border-slate-700 bg-slate-800 text-slate-300 shadow-md hover:bg-indigo-600 hover:text-white transition-all text-xs cursor-pointer"
      ...
      <div className="flex items-center justify-between border-b border-slate-800/60 px-3 py-2.5 bg-slate-900/40">
        {!collapsed ? (
          <div className="flex items-center justify-between w-full gap-2">
            ...
            <Link
              href="/materias"
              className="text-[10px] text-slate-500 hover:text-slate-300 font-semibold p-1 hover:bg-slate-800 rounded transition-colors shrink-0"
          ...
          <span className="mx-auto text-xs font-bold text-indigo-400" title={formattedSubjectName}>
            📖
          </span>
        )}
      </div>

      {/* Sección 3: Pestañas del Workspace con Acordeón Inteligente */}
          ...
          return (
            <div key={item.href} className="flex flex-col gap-0.5">
              <div className="flex items-center justify-between">
                ...
                {/* Botón de toggle desplegable para Temas */}
                {!collapsed && item.hasSubmenu && (
                  <button
                    ...
                    className="p-1.5 text-slate-400 hover:text-white hover:bg-slate-800/80 rounded-lg transition-colors ml-1 cursor-pointer text-[10px]"
      ...
      <div className="border-t border-slate-800/60 p-2.5 bg-slate-950 flex flex-col gap-2">
        ...
        {!collapsed ? (
          ...
          <div
            className="mx-auto flex h-7 w-7 items-center justify-center rounded-xl bg-amber-500/10 text-amber-400 text-xs font-bold"
